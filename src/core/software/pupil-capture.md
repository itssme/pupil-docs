...
* Streaming Surfaces with Pupil Capture - Detected surfaces as well as gaze positions relative to the surface are broadcast under the `surfaces` topic. Check out [this video](http://youtu.be/qHmfMxGST7A) for a demonstration.
